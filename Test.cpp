...
Notebook notebook;
    ...
    notebook.write(1,0,0,Direction::Horizontal,"lior");
    CHECK_THROWS(notebook.write(1,0,0,Direction::Horizontal,"lior"));
    CHECK_THROWS(notebook.write(1,0,0,Direction::Vertical,"lior"));
    CHECK_THROWS(notebook.write(1,0,2,Direction::Vertical,"lior"));
    CHECK_THROWS(notebook.write(1,0,3,Direction::Vertical,"lior"));
    CHECK_THROWS(notebook.write(1,0,2,Direction::Horizontal,"lior"));
    CHECK_THROWS(notebook.write(1,0,3,Direction::Horizontal,"lior"));

    //Trying to write on erased pos: horizontal and vertical
    notebook.erase(1,0,0,Direction::Horizontal,5);
    CHECK_THROWS(notebook.write(1,0,0,Direction::Horizontal,"lior"));
    CHECK_THROWS(notebook.write(1,0,0,Direction::Vertical,"lior"));
    CHECK_THROWS(notebook.write(1,0,2,Direction::Vertical,"lior"));
    CHECK_THROWS(notebook.write(1,0,3,Direction::Vertical,"lior"));
...
TEST_CASE("valid position") {
    ...
    //read function
    CHECK_THROWS(notebook.read(100, 99, 51, Direction::Horizontal, 3));
